    ...
    <div className="container">
      ...
      <div className="mapGide absolute top-[270px] right-[200px] border-[1px] border-black p-[10px]">
        <div className="pair flex gap-[5px] items-center">
          <div className="w-[30px] h-[30px] border-[1px] border-black bg-[#c1f1ba] mb-[5px]"></div>
          <div>Available</div>
        </div>
        <div className="pair flex gap-[5px] items-center">
          <div className="w-[30px] h-[30px] border-[1px] border-black bg-[#fdbaa9] mb-[5px]"></div>
          <div>Reserved</div>
        </div>
        <div className="pair flex gap-[5px] items-center">
          <div className="w-[30px] h-[30px] border-[1px] border-black bg-[#f1e4ba] mb-[5px]"></div>
          <div>Pending</div>
        </div>
        <div className="pair flex gap-[5px] items-center">
          <div className="w-[30px] h-[30px] border-[1px] border-black bg-[lightgrey] mb-[5px]"></div>
          <div>Not Exist</div>
        </div>
      </div>
